...
Ported from ETO/eval_agent/envs/alfworld_env.py with imports updated.
"""
import re
import json
import logging
...
from agent_distill.env.base_env import BaseEnv
from agent_distill.env.alfworld_task import AlfWorldTask
from agent_distill.prompts.templates import prompt_with_icl
from agent_distill.env.state import State
...
class AlfWorldEnv(BaseEnv):
    ...
    def step(self, llm_output: str) -> Tuple[str, State]:
        ...
        try:
            ...
            self.state.reward = 0
            observation = "Observation: Error Input. Your input must contains 'Action: '"
            self.state.history.append({
                "role": "user",
                "content": observation,
            })
